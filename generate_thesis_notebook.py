"""
Generate a leakage-safe thesis notebook for the updated 1M customer churn data.

Outputs:
- duc_le_churn_thesis_notebook.ipynb
...
IPYNB_PATH = ROOT / "duc_le_churn_thesis_notebook.ipynb"
PY_PATH = ROOT / "duc_le_churn_thesis_notebook.py"
...
with PY_PATH.open("w", encoding="utf-8") as handle:
...
print(f"Wrote {IPYNB_PATH.name}")
print(f"Wrote {PY_PATH.name}")
